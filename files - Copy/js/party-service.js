class PartyService {
    ...
    async queryParty(partyId) {
        const response = await fetch(
            `https://epic-party-proxy.beatbot.xyz/party/api/v1/Fortnite/parties/${partyId}`,
            {
                headers: {
    ...
    async queryUser() {
        const response = await fetch(
            `https://epic-party-proxy.beatbot.xyz/party/api/v1/Fortnite/user/${this.session.account_id}`,
            {
                headers: {
                    Authorization: `${this.session.token_type} ${this.session.access_token}`,
                    Accept: 'application/json',
    ...
    */
    async queryPartyFromPing(from, to) {
        const response = await fetch(
            `https://epic-party-proxy.beatbot.xyz/party/api/v1/Fortnite/user/${to}/pings/${from}/parties`,
            {
                headers: {
                    Authorization: `${this.session.token_type} ${this.session.access_token}`,
                    Accept: 'application/json'
    ...
    async joinPartyFromPing(pingerId, JabberId) {
        const response = await fetch(
            `https://epic-party-proxy.beatbot.xyz/party/api/v1/Fortnite/user/${this.session.account_id}/pings/${pingerId}/join`,
            {
                method: 'POST',
                headers: {
                    Authorization: `${this.session.token_type} ${this.session.access_token}`,
    ...
    */
    async joinParty(partyId, JabberId) {
        const response = await fetch(
            `https://epic-party-proxy.beatbot.xyz/party/api/v1/Fortnite/parties/${partyId}/members/${this.session.account_id}/join`,
            {
                method: 'POST',
                headers: {
                    Authorization: `${this.session.token_type} ${this.session.access_token}`,
    ...
    async updateMemberMeta(update, deleted) {
        ...
        const response = await fetch(
            `https://epic-party-proxy.beatbot.xyz/party/api/v1/Fortnite/parties/${this.party.id}/members/${this.session.account_id}/meta`,
            {
                method: 'PATCH',
                headers: {
                    Authorization: `${this.session.token_type} ${this.session.access_token}`,
